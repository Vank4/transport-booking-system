...
router.post("/", authMiddleware, authorizeRoles("ADMIN"), validate(createFlightFareSchema, "body"), flightFareController.createFlightFare);
...
router.put("/:id", authMiddleware, authorizeRoles("ADMIN"), validate(updateFlightFareSchema, "body"), flightFareController.updateFlightFare);
router.delete("/:id", authMiddleware, authorizeRoles("ADMIN"), flightFareController.deleteFlightFare);
